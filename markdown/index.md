...
The implementation of the project design can be classified into the program components
that make up how the game features were coded, which include the Wordle Game Logic, Game
Reset, SPI Display, and AWS Game Notification blocks. Alternatively, there are also the
blocks that make up the interfacing with peripheral components/services such as the IR
Remote, BMA222, Adafruit OLED, and AWS blocks.

## Functional Blocks

### AWS Game Email Notification
